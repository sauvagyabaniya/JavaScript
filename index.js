...
//     }
//     // resolve("Promise Fulfilled");               //this is not needed coz we are taking if else 
// }); 
// res.then((param)=> console.log(param)).catch((error)=> console.log(error));
//we can write multiple chain in promises


// //JSON AND FETCH API
// // JSON stands for Java Script Object notaiton
// // it is selfdescribing and easy to understanda
